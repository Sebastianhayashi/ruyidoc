import{_ as s,c as a,o as n,a1 as e}from"./chunks/framework.BZ4TFaZ1.js";const v=JSON.parse('{"title":"为 RISC-V 开发板安装操作系统","description":"","frontmatter":{},"headers":[],"relativePath":"doc/RuyiSDK/case2.md","filePath":"doc/RuyiSDK/case2.md"}'),p={name:"doc/RuyiSDK/case2.md"},i=e(`<h1 id="为-risc-v-开发板安装操作系统" tabindex="-1">为 RISC-V 开发板安装操作系统 <a class="header-anchor" href="#为-risc-v-开发板安装操作系统" aria-label="Permalink to &quot;为 RISC-V 开发板安装操作系统&quot;">​</a></h1><p>目前 <code>ruyi</code> 工具提供了更为简便的操作系统安装方式，通过以下步骤以及相关引导即可完成安装。</p><h2 id="环境" tabindex="-1">环境 <a class="header-anchor" href="#环境" aria-label="Permalink to &quot;环境&quot;">​</a></h2><p>本文基于以下环境进行操作：</p><ul><li>硬件：x86_64 PC</li><li>软件：Ubuntu 22.04</li></ul><h4 id="其他说明" tabindex="-1">其他说明 <a class="header-anchor" href="#其他说明" aria-label="Permalink to &quot;其他说明&quot;">​</a></h4><ul><li>在任意 Linux 系统下皆可完成下文操作</li></ul><p>连接方式，以下任选：</p><ol><li>RISC-V 开发板以 USB 连接线接入 PC（若可以连接，推荐该方式）</li><li>将 RISC-V 开发板 SD 卡通过读卡器接入 PC</li></ol><h2 id="安装操作系统" tabindex="-1">安装操作系统 <a class="header-anchor" href="#安装操作系统" aria-label="Permalink to &quot;安装操作系统&quot;">​</a></h2><p>在确保已安装 <code>ruyi</code> 包管理器，并且测试 <code>ruyi -V</code> 正常输出版本相关信息后，请继续以下操作。</p><p><code>ruyi</code> 工具提供了为 RISC-V 开发板安装操作系统的功能，为任一型号的 RISC-V 开发板安装镜像都只需要执行：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">ruyi</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> device</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> provision</span></span></code></pre></div><p>该命令将会返回工具目前所支持的 RISC-V 开发板，选择开发板后将返回所有支持指定开发板的操作系统：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>RuyiSDK Device Provisioning Wizard</span></span>
